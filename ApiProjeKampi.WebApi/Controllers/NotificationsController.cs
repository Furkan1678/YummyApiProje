...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class NotificationsController : ControllerBase
    {
        ...
        public IActionResult CreateNotification(CreateNotificationDto createNotificationDto)
        {
            ...
            return Ok("Notification Ekleme İşlemi Başarılı");
        }
        ...
        public IActionResult DeleteNotification(int id)
        {
            ...
            _context.SaveChanges();
            return Ok("Notification Silme İşlemi Başarılı");
        }
        ...
        [HttpPut]
        public IActionResult UpdateNotification(ResultNotificationDto updateNotificationDto)
        {
            var value = _mapper.Map<Notification>(updateNotificationDto);
            _context.Notifications.Update(value);
            _context.SaveChanges();
            return Ok("Notification İşlemi Başarıyla Güncellendi.");
        }
    }
}
