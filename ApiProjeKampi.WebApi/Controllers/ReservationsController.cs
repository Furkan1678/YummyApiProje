...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class ReservationsController : ControllerBase
    {
        ...
        {
            //var value = _context.Reservations.Update(Reservation);
            //_context.SaveChanges();
        ...
        {
            var value = _context.Reservations.Sum(c=>c.CountofPeople);
            return Ok(value);
        }
        ...
        {
            var value = _context.Reservations.Where(c=>c.ReservationStatus == "False").Count();
            return Ok(value);
        }
        ...
        {
            var value = _context.Reservations.Where(c => c.ReservationStatus == "True").Count();
            return Ok(value);
        }
